...
<h4 class="margin-bottom-15">All Problem Non Solve List</h4>
...
$select_table = "select * from problem,lab_assistant where lab_assistant.Lid=problem.Lab and Assistant='$UID' and ResolveDetails!='' and (Resolve='partially' or Resolve='No')";

if($_SESSION['UtypeAdmin']=="Admin")
{
$select_table = "select * from problem,lab_assistant where lab_assistant.Lid=problem.Lab and ResolveDetails!='' and (Resolve='partially' or Resolve='No')";
}
